...
<html lang="en">
	...
	<meta property="og:title" content="aroceu (answers)" />
...
.column1 .result:nth-child(odd), .column2 .result:nth-child(even), .column3 .result:nth-child(odd){
	transform: rotate(-2deg);
}

.column1 .result:nth-child(even), .column2 .result:nth-child(odd), .column3 .result:nth-child(even){
	transform: rotate(2deg);
}
