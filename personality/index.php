...
.box{
    background: #fff;
		...
		border-bottom: 1px solid #5C98B2;
        	box-shadow: 0 5px 0 rgb(255, 199, 198);
    width: 55em;
    margin: 1.5em auto;
    padding: 1em;
}
...
@media (max-width: 600px) {
	...
	<a href="../../">home</a>
	<a href="../../me">me</a>
	<a href="../../me/pics">pics</a>
	<a href="../../log">log</a>
</nav>
            
        </div>

        <div id="classifications" class="box">
            
            <details><summary><h2>Classifications</h2></summary>
            
            <ul>
                <li><b>Enneagram/Tritype:</b> 5w4sx / 584</li>
                <li><b>MBTI:</b> INTP</li>
                ...
                <li><b>Grecoroman God:</b> Artemis / Hades</li>
            </ul>
        ...
        <div id="tropekins" class="box">
            
            <details><summary><h2>Tropes/Kinnies</h2></summary>
            ...
            <ul>
                ...
                <br /><a href="https://tvtropes.org/pmwiki/pmwiki.php/Main/CoolBigSis">Cool Big Sister</a> / <a href="https://tvtropes.org/pmwiki/pmwiki.php/Main/BigBrotherInstinct">Big Sister Instinct</a></li>
                <li><b>Character:</b> 
            ...
            <img src="blackamericanbobtail.png" alt="Black American Bobtail" />
        ...
        <div id="results" class="box">
            ...
            <p>These are select personality test results that aren't summarized above but are still accurate to me.</p>
